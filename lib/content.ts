...
export const estudos: ContentItem[] = [
  ...
  {
    slug: "piloto-ibs-live-1",
    tag: "Vídeo",
    titulo: "Piloto IBS | Live 1 — CGIBS",
    subtitulo: "Comitê Gestor do IBS · fev 2026",
    porQueImporta:
      "A live inaugural da série institucional do CGIBS apresenta o funcionamento do Projeto Piloto do IBS e orienta as administrações tributárias sobre alinhamento operacional e padrões de apuração assistida.",
    fonte: "CGIBS — YouTube",
    formato: "Vídeo",
    tema: "CG-IBS · Piloto IBS",
    profundidade: "Aprofundado",
    data: "fev 2026",
  ...
  {
    slug: "piloto-ibs-live-2",
    tag: "Vídeo",
    titulo: "Piloto IBS | Live 2 — CGIBS",
    subtitulo: "Comitê Gestor do IBS · fev 2026",
    porQueImporta:
      "A segunda live do CGIBS aprofunda aspectos operacionais do piloto de apuração assistida do IBS — essencial para equipes de TI, arrecadação e fiscalização estadual.",
    fonte: "CGIBS — YouTube",
    formato: "Vídeo",
    tema: "CG-IBS · Piloto IBS",
    profundidade: "Aprofundado",
  ...
  {
    slug: "ccj-impostos-estaduais-mai2025",
    tag: "Vídeo",
    titulo: "CCJ debate impostos estaduais na reforma tributária",
    subtitulo: "TV Senado · mai 2025",
    porQueImporta:
      "Audiência pública da CCJ dedicada aos impactos da reforma sobre tributos estaduais. Registra a discussão sobre transição, perdas potenciais e o desenho do IBS sob a ótica dos estados — tema central para o ES.",
    fonte: "TV Senado — YouTube",
    formato: "Vídeo",
    tema: "Federalismo / Senado",
    profundidade: "Aprofundado",
    data: "mai 2025",
  ...
  {
    slug: "ccj-efeitos-estados-municipios-jun2025",
    tag: "Vídeo",
    titulo: "CCJ debate efeitos da reforma tributária nos estados e municípios",
    subtitulo: "TV Senado · jun 2025",
    porQueImporta:
      "Audiência pública da CCJ centrada nos efeitos da reforma sobre estados e municípios, com ênfase na criação definitiva do Comitê Gestor do IBS. Captura riscos e contrapartidas federativas explicitados no nível legislativo.",
    fonte: "TV Senado — YouTube",
    formato: "Vídeo",
    tema: "Federalismo / Senado",
    profundidade: "Introdutório",
...
export const radar: ContentItem[] = [
  ...
  },
  {
    ...
    porQueImporta:
      "Controle externo e governança do CGIBS se articulam: qualidade dos dados e metodologia de distribuição serão tema de escrutínio permanente do TCU. Para o Tesouro do ES, sinaliza exigências crescentes de transparência nos repasses do IBS.",
    fonte: "Tribunal de Contas da União",
    url: "https://portal.tcu.gov.br/imprensa/noticias/tcu-visita-comite-gestor-do-imposto-sobre-bens-e-servicos",
  },
  {
    slug: "sefaz-seminario-municipios-out2025",
    date: "02",
    month: "Out",
    tag: "ES · SEFAZ-ES",
    titulo: "SEFAZ-ES realiza seminário para debater impactos da reforma nas administrações municipais",
    descricao:
      "A SEFAZ-ES reuniu gestores e técnicos para discutir panorama da reforma, documentos fiscais eletrônicos, contencioso, split payment e apuração assistida. Incluiu exposição específica sobre o fim dos benefícios fiscais no ES.",
    porQueImporta:
      "Um dos materiais mais aderentes à realidade do Tesouro Estadual: organiza a agenda de implementação com foco em estados e municípios capixabas e mostra quais temas a SEFAZ-ES julgou prioritários para capacitação institucional.",
    fonte: "SEFAZ-ES",
